...
DEFAULT_PERSISTENCE_CONFIG = {'name': 'exporters.persistence.pickle_persistence.PicklePersistence',
...
DEFAULT_FORMATTER_CONFIG = {"name": "exporters.export_formatter.json_export_formatter.JsonExportFormatter",
                           "options": {}}
