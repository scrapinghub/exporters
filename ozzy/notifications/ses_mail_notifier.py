...
class SESMailNotifier(BaseNotifier):
    ...
    supported_options = {
        ...
        'access_key': {'type': basestring, 'env_fallback': 'ozzy.MAIL_AWS_ACCESS_KEY'},
        'secret_key': {'type': basestring, 'env_fallback': 'ozzy.MAIL_AWS_SECRET_KEY'},
