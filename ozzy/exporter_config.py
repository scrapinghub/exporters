...
import json
from ozzy.utils import maybe_cast_list
from ozzy.exceptions import ConfigCheckError
from ozzy.defaults import (
...
def module_options():
    ...
    for module_type in MODULE_TYPES:
        module = import_module('ozzy.{}'.format(module_type))
