...
from ozzy.default_retries import retry_long, retry_short
from ozzy.exceptions import ConfigurationError, InvalidDateRangeError
import logging

from ozzy.utils import get_bucket_name
...
class S3Reader(BaseReader):
    ...
    supported_options = {
        ...
        'aws_access_key_id': {
            'type': basestring,
            'env_fallback': 'ozzy.S3READER_AWS_KEY'
        },
        'aws_secret_access_key': {
            'type': basestring,
            'env_fallback': 'ozzy.S3READER_AWS_SECRET'
        },
