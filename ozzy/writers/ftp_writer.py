...
from ozzy.progress_callback import FtpUploadProgress
...
class FTPWriter(FilebaseBaseWriter):
    ...
    supported_options = {
        ...
        'ftp_user': {'type': six.string_types, 'env_fallback': 'ozzy.FTP_USER'},
        'ftp_password': {'type': six.string_types, 'env_fallback': 'ozzy.FTP_PASSWORD'},
