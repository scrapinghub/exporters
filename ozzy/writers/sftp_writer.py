...
from ozzy.progress_callback import SftpUploadProgress
...
class SFTPWriter(FilebaseBaseWriter):
    ...
    supported_options = {
        ...
        'sftp_user': {'type': six.string_types, 'env_fallback': 'ozzy.SFTP_USER'},
        'sftp_password': {'type': six.string_types, 'env_fallback': 'ozzy.SFTP_PASSWORD'},
